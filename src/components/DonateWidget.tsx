...
export default function DonateWidget({firstBtn, secBtn, quote} : {firstBtn:string, secBtn:string, quote:string}) {
  ...
  return (
    <div className="hidden lg:block sticky top-10 ease-in-out duration-200 col-span-1 overflow-hidden bg-gray-100 rounded-lg ml-9 flex flex-col max-h-[650px]">
      <div className={`flex bg-[url(https://www.ajayonlinestall.com/wp-content/uploads/2021/02/9789386850560.png)] bg-no-repeat bg-center h-3/4`}>
        <p className="text-gray-600 w-full italic justify-center items-center">{quote}</p>
      </div>
