...
import redirectToRazorPay from "@/utils/redirectToRazorPay";
...
const getData = async (slug: string) => {
  ...
  const newData = await fetch(process.env.NEXT_PUBLIC_STRAPI_URL + `/campaigns?filters[slug][$eq]=${slug}`, {cache: 'no-cache'})
    ...
    Data && (
      <div className="">
        <div className="mx-6 lg:px-20 mt-2">
          <h1 className="mb-2 sm:mr-12 py-6 capitalize font-bold lg:text-4xl text-gray-800 text-4xl">
            {Data["title"]}
          </h1>
